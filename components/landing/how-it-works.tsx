...
const steps = [
  ...
  },
  {
    ...
    description:
      "Choose a convenient time for us to collect your laundry directly from your doorstep.",
  },
  {
    number: "03",
    title: "Expert Care",
  ...
  },
  {
    ...
    description:
      "Receive your freshly cleaned clothes back at your door, perfectly folded and ready to wear.",
  },
];
      ...
      <div className="container">
        ...
        >
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            How Al-Tayseer Works
          </p>
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Our streamlined process makes getting fresh, clean clothes
            effortless. From pickup to delivery, we handle everything so you
            don't have to.
          </p>
        </motion.div>
                ...
                <div className="flex flex-col h-full">
                  ...
                  {index < steps.length - 1 && (
                    <div className="hidden lg:block absolute top-10 right-0 transform translate-x-1/2">
                      ...
                      >
                        <path
                          d="M0 6H38.5M38.5 6L33.5 1M38.5 6L33.5 11"
                          stroke="#0284c7"
                          strokeWidth="2"
                        />
                      </svg>
